...
* [🤖 Node Runner](paths/node-runner/README.md)
  ...
  * [✈️ Zero To Node](paths/node-runner/zero-to-node/README.md)
    * [1-1: Server Setup](paths/node-runner/zero-to-node/1-1-server-setup.md)
    * [1-2: Configure DNS](paths/node-runner/zero-to-node/1-2-configure-dns.md)
    * [1-3: Login with SSH](paths/node-runner/zero-to-node/1-3-ssh-login.md)
    * [1-4: Set the hostname](paths/node-runner/zero-to-node/1-4-set-hostname.md)
    * [1-5: Create a User](paths/node-runner/zero-to-node/1-5-create-user.md)
    * [2-1: Install dependencies](paths/node-runner/zero-to-node/2-1-install-dependencies.md)
    * [2-2: Install Go](paths/node-runner/zero-to-node/2-2-install-go.md)
    * [2-3: Install Pocket Core](paths/node-runner/zero-to-node/2-3-install-pocket.md)
    * [2-4: Create a Pocket Account](paths/node-runner/zero-to-node/2-4-create-account.md)
    * [3-1: Create config.json](paths/node-runner/zero-to-node/3-1-config-json.md)
    * [3-2: Create chains.json](paths/node-runner/zero-to-node/3-2-chains-json.md)
    * [3-3: Create genesis.json](paths/node-runner/zero-to-node/3-3-genesis-json.md)
    * [3-4: Set open file limits](paths/node-runner/zero-to-node/3-4-ulimit-settings.md)
    * [4-1: Download Snapshot](paths/node-runner/zero-to-node/4-1-snapshot-download.md)
    * [4-2: Configure systemd](paths/node-runner/zero-to-node/4-2-systemd-service.md)
    * [4-3: Setup SSL](paths/node-runner/zero-to-node/4-3-ssl-setup.md)
    * [4-4: Configure Nginx](paths/node-runner/zero-to-node/4-4-nginx-config.md)
    * [4-5: Enable UFW](paths/node-runner/zero-to-node/4-5-ufw-settings.md)
    * [5-1: Test everything](paths/node-runner/zero-to-node/5-1-testing.md)
    * [5-2: Staking your node](paths/node-runner/zero-to-node/5-2-staking.md)
    * [Next Steps](paths/node-runner/zero-to-node/5-3-next-steps.md)
