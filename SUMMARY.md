...
* [🤖 Node Runner](paths/node-runner/README.md)
  ...
  * [✈️ Zero To Node](paths/node-runner/zero-to-node/README.md)
    * [Server Setup](paths/node-runner/zero-to-node/server-setup.md)
    * [Software installation](paths/node-runner/zero-to-node/software-install.md)
    * [Pocket configuration](paths/node-runner/zero-to-node/pocket-config.md)
    * [Proxy configuration](paths/node-runner/zero-to-node/proxy-config.md)
    * [Going live](paths/node-runner/zero-to-node/going-live.md)
