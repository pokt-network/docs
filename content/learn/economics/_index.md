...
{{% notice style="info" %}}
The current price per relay is called `BaseRelaysPerPOKT`, and you can find the current value on the [Protocol Parameters]({{< relref "../protocol-parameters#baserelaysperpokt" >}}) page.
{{% /notice %}}
...
{{% notice style="info" %}}
The current block producer percentage is called `ProposerAllocation`, and you can find the current value on the [Protocol Parameters]({{< relref "../protocol-parameters#proposerallocation" >}}) page.

Furthermore, the DAO allocation of block rewards is called `DAOAllocation`, and that also can be found on the [Protocol Parameters]({{< relref "../protocol-parameters#daoallocation" >}}) page.
{{% /notice %}}
